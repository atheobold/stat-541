...
Join the [Stat 541 Server](https://discord.gg/aMwurQm4Zd) to start experimenting with the interface. When you join the server, you will be given some suggestions to get started.
