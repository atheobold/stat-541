...
quiz_url <- "https://canvas.calpoly.edu/courses/16654/quizzes/11734"
library(tidyverse)
library(flair)
library(leaflet)
```
...
a) Assuming we've decided to visualize one of the categorical variables in our dataset, which of the following is a plot type we could use that's not in the core listed above:
...
b) What package does this site suggest for creating interactive maps in R?
