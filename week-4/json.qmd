...
This is a powerful process, but you might be able to see how we don't necessarily want to do this process repeatedly for every value `spread_all()` was not able to parse. Do you see a way you could use iteration to complete this task?
