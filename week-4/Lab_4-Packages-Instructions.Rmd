...
In this lab, you and your group will create your very own small R Package!

On Canvas, under the "People" tab, you will find "Lab 4 Groups".  Get in touch
with your randomly assigned groupmates as soon as possible.
...
Your **group leader** (see Canvas) will now need to create the initial empty
...
life easier.  In the RStudio project that opened automatically for yoru package
...
We expect all group members to contribute a roughly equal amount to the package.

We will be able to check this on GitHub, as we can see who submitted each edit
via Pull Request.

If you have any concerns about the functioning of your group, please do not hesistate
to contact either of us directly.


## Challenge Points

There is **no challenge** this week.  Instead, your package serves as your 
challenge submission.

Bonuses apply to all group members.

#### Professor Awards

We will give +5 points for...

* Our favorite package name
* The most fun package
* The most useful package
* The cleanest and most elegant code

#### Voting

This week, Dr. Glanz and Dr. Bodwin will not have a secret submission.

There will also only be 7 total submissions.

However, the usual **+10 bonus** for being in the top 3 will apply.


#### CRAN Check

Recall that the requirements for being accepted to CRAN are quite strict.

You can see if your package is in tip-top shape by clicking the "Check" button
under the "Build" pane in RStudio.

Any package that passes this Check with 0 Errors and 0 Warnings will receive an
automatic **+10 bonus.**
